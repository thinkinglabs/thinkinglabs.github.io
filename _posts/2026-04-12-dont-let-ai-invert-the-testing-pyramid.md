...
It is economics, because most regressions should be detected by *Unit Tests* to give engineers the confidence that they can move on once these tests pass the [*Commit Build*](#commit-build).  Consequently, they must be extremely fast, allowing engineers to execute them many, many times as part of the [*Local Build*](#local-build) and by machines remotely as part of the *Commit Build*, to uncover regressions quickly. It is downright impossible to achieve this level of fast feedback with end-to-end tests, because they lag, and not to mention, they will never achieve the same coverage as *Unit Tests*, therefore preventing them from uncovering some regressions.
...
Using AI on low-quality codebases poses considerable risks, requiring a high level of human intervention and assistance from code quality assessment tooling. However, according to [CodeScene's Code Red white paper](https://codescene.com/hubfs/web_docs/Business-impact-of-code-quality.pdf), only 10% of the organisations measure code health and technical debt, while engineers waste 42% of their time dealing with poor quality code. At the same time, from experience, most codebases are a facade: a decent-looking house, supported by seemingly working end-to-end tests, yet sitting on a foundation of rotting timber. The tragedy is that people often do not realise the danger; they have not seen what a solid foundation is, nor what good design and quality code look like. So, good luck with that!
...
When I challenge this "end-to-end test-first" approach, the common defence is to reference the [Testing Trophy](https://kentcdodds.com/blog/the-testing-trophy-and-testing-classifications) and backing this with Martin Fowler's [On the Diverse And Fantastical Shapes of Testing](https://martinfowler.com/articles/2021-test-shapes.html).
...
[Elizabeth Zagroba](https://mastodon.social/@ez@chaos.social) and [Lisi Hocke](https://mastodon.social/@lisihocke) for reviewing and providing insights to round the article. My best friend [Martin Van Aken](https://www.joyouscoding.com/) for removing the sharp edges.
...
- [A Set of Unit Testing Rules](https://www.artima.com/weblogs/viewpost.jsp?thread=126923), Michael Feathers, 2005
